...
import { Terminal, Mail, Lock, User, Github, Loader2 } from 'lucide-react';
...
export function Signup() {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      setAuthError(err.message || 'Failed to sign up with Google');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleGithubSignup = async () => {
    ...
    try {
      ...
      setAuthError(err.message || 'Failed to sign up with GitHub');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4">
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-400">Start with 5 free credits</p>
        </div>
